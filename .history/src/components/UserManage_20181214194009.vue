                  ...
                  <v-layout row wrap>
                    <v-flex v-for="(item, index) in userInfo" :key="index">
                      <v-list-tile v-for="(value, key) in item" :key="key">
                        ...
                        <v-list-tile-content class="align-end" v-if="value.eng === 'gender'">{{ formatGender(items.gender) }}</v-list-tile-content>
                        <v-list-tile-content class="align-end" v-else-if="value.eng === 'user_role'">{{ formatUserRole(items.user_role) }}</v-list-tile-content>
                        <v-list-tile-content class="align-end" v-else-if="key === 'country'">
                          {{getCountry()}}
                        </v-list-tile-content>
                        <v-list-tile-content class="align-end" v-else>{{ items[value.eng] }}</v-list-tile-content>
                      </v-list-tile>
                    </v-flex>
