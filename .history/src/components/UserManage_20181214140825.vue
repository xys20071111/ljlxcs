        ...
        <v-container fluid grid-list-md>
          <v-layout row wrap>
            ...
            <v-flex sm12 d-flex >
              <v-card tile flat>
                <v-list dense>
                  <Dialog color="info" butCont="编辑用户信息" :setMan="setMan" which="setMan" @setMan="setManFun"></Dialog>
                  <Dialog color="info" butCont="冻结用户" alert="true" :unbindWho="setMan" which="freezeMan" @freezeMan="freezeMan"></Dialog>
...
export default {
  ...
  methods: {
    ...
    unbindClass (props, whichEle) {
      ...
      let whichMethod = {addClass: 'joinclass', unbindClass: 'quitclass'}
      let whichData = {}
      whichEle === 'addClass' && (whichData = {'uid': this.items.user_id, 'classid': props.class_id})
      whichEle === 'unbindClass' && (whichData = {'uid': this.items.user_id, 'classid': props})
      let params = {
        api: this.HOSTCSM,
        param: {
