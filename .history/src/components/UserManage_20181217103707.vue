      ...
      <v-list class="pt-0" dense>
        ...
        <v-container fluid grid-list-md>
          <v-layout row wrap>
            ...
            <Card which="child" :data="items.ex.childlist" v-if="items.ex && items.ex.childlist" slot-scope="">
              <template slot="buttonSlot" slot-scope="{props}">
                <v-flex md12>
                  <v-list-tile>
                    <Dialog color="info" butCont="解绑孩子" alert="true" :unbindWho="props.item" which="unbindchild" @unbindchild="setEleFun"></Dialog>
                  </v-list-tile>
            ...
            <Card which="class" :data="items.ex.teahcer.ClsList" v-if="items.ex && items.ex.teacher && items.ex.teahcer.ClsList">
              <v-flex md6 slot="buttonSlot" slot-scope="{props}">
                <v-list-tile>
                  <Dialog color="info" butCont="退出班级" alert="true" :unbindWho="props.item" which="unbindClass" @unbindClass="setEleFun"></Dialog>
                </v-list-tile>
              </v-flex>
