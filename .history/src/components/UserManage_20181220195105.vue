  ...
  <v-layout column wrap>
    ...
    <v-flex>
      <dataTable1 which="userManage0" :desserts="desserts" :pagination.sync="pagination" :totalDesserts="totalDesserts"
        :loading="loading" @getclasslist="getUserList" @clickList="clickListTableItem" :news="news" :setNew.sync="news">
      </dataTable1>
      <!-- <v-data-table
    ...
    >
      ...
      <v-list class="pa-1">
        ...
        <v-list-tile avatar>
          <v-list-tile-avatar>
            <Dialog image="true" :imageArr="[40,290,290,formatAvatar(items.avatar)]" :disabledOrNo="formatAvatar(items.avatar).indexOf('uLogoNone.jpg') !== -1"></Dialog>
          </v-list-tile-avatar>
          <v-list-tile-content>
...
export default {
  ...
  methods: {
    ...
    getUserList (props) {
      ...
      this.role = props
      this.loading = true
      let dataObj = {'role': !props ? 0 : 4 - props, 'num': this.pagination.page, 'size': this.pagination.rowsPerPage === 1 ? 20 : this.pagination.rowsPerPage}
