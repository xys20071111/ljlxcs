...
export default {
  ...
  created () {
    window.addEventListener('scroll', function (e) {
      ...
      console.log(document.documentElement.scrollTop, document.documentElement.windowHeight, document.documentElement.scrollHeight)
      if (document.documentElement.scrollTop + document.documentElement.windowHeight === document.documentElement.scrollHeight) {
        alert(0)
      }
    })
  },
