<template>
  <div>
    ...
    <!-- <dataTable which="allIntegral1" :desserts="desserts" :loading="loading" :news="news" :clickWhich="clickWhich"
      :setNew.sync="news" @clickList="clickListTableItem" @getNew="getNew" @clickjump="jumpToUserClass">
    </dataTable> -->
  ...
  methods: {
    ...
    getAllDetail (newPage) {
      ...
      let dataObj = {
        ...
        size: (this.pagination.rowsPerPage === 1 || this.pagination.rowsPerPage === 0) ? 20 : this.pagination.rowsPerPage
      }
      axios(this.HOSTCSM, 'assetdetail', dataObj, cb => {
        ...
        console.log(this.totalDesserts)
