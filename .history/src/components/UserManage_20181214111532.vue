        ...
        <v-container fluid grid-list-md>
          <v-layout row wrap>
            ...
            <v-flex sm12 d-flex >
              <v-card tile flat>
                <v-list dense>
                  <Dialog color="info" butCont="编辑用户信息" :setMan="setMan" which="setMan" @setManFun="setManFun"></Dialog>
                  <Dialog color="info" butCont="冻结用户" alert="true" :unbindWho="setMan" which="freezeMan" @freezeFun="freezeFun"></Dialog>
                      ...
                      <v-layout row wrap>
                        <v-flex sm12 xs12 md6>
                          ...
                          <v-list-tile>
                            ...
                            <v-list-tile-content class="align-end">{{ props.item.class_name && (props.item.class_name)}}</v-list-tile-content>
                          </v-list-tile>
                          <v-list-tile>
