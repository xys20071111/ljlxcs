    ...
    >
      ...
      <v-list class="pa-1">
        ...
        <v-list-tile avatar>
          <v-list-tile-avatar>
            <v-layout>
              <v-dialog v-model="dialog" max-width="290" :disabled="formatAvatar(items.avatar).indexOf('uLogoNone.jpg') !== -1">
                <img slot="activator" style="width:40px;height:40px" :src="formatAvatar(items.avatar)">
                <v-card>
                  <img :src="formatAvatar(items.avatar)" style="width:290px;height:290px">
                  <v-card-actions>
                    <v-spacer></v-spacer>
