      ...
      <v-list class="pt-0" dense>
        ...
        <v-container fluid grid-list-md>
          <v-layout row wrap>
            ...
            <Card which="child" :data="items.ex.childlist" v-if="items.ex">
            ...
            <Card which="class" :data="items.ex.teahcer.ClsList" v-if="items.ex && items.ex.teahcer">
              <v-flex md12 slot="buttonSlot" slot-scope="{props}">
                <v-list-tile>
                  <Dialog color="info" butCont="退出班级" alert="true" :unbindWho="props.item" which="unbindClass" @unbindClass="setEleFun"></Dialog>
                </v-list-tile>
            ...
            <Card which="parent" :data="items.ex.stu.Parents" v-if="items.ex && items.ex.stu">
              <!-- <v-flex md12 slot="buttonSlot" slot-scope="{props}">
                <v-list-tile>
                  <Dialog color="info" butCont="退出班级" alert="true" :unbindWho="props.item" which="unbindClass" @unbindClass="setEleFun"></Dialog>
                </v-list-tile>
            ...
            <Card which="stuclass" :data="items.ex.stu.ClsList" v-if="items.ex && items.ex.stu">
              <v-flex md12 slot="buttonSlot" slot-scope="{props}">
                <v-list-tile>
                  <Dialog color="info" butCont="退出班级" alert="true" :unbindWho="props.item" which="unbindClass" @unbindClass="setEleFun"></Dialog>
                </v-list-tile>
