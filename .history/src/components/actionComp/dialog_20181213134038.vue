      ...
      <v-card>
        ...
        <v-card-text>
          <v-container grid-list-md style="padding:0">
            ...
            <v-layout nowrap style="align-items:center">
              <v-flex style="flex:0 0 auto;font-size:16px" blue--text>用户身份：</v-flex>
              <v-radio-group v-model="state" hide-details row style="margin: 10px 10px 10px 0px;flex: 1;flex-wrap:nowrap">
                <v-flex style="display:flex" wrap>
                  <v-radio
