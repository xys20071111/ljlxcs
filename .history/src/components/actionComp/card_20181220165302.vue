    ...
    data () {
      return {
        ...
        allKey: {
          ...
          orderGods: [
            [['amount', '变更金额:'], ['amount_status', '收支情况:'], ['before_amount', '变更前金额:'], ['app_id', 'app_id:'], ['currecy_id', '货币类型:'],
              ['current_amount', '余额:'], ['detail_id', 'detail_id:']
            ],
            [['op_user_id', 'op_user_id:'], ['sub_id', 'sub_id:'], ['user_id', '用户ID:'], ['in_time', 'in_time:'], ['task_time', '变更时间:'], ['remark', '备注:'], ['ip', 'ip:']]
          ]
        },
        formatGender,
        formatUserRole,
