  ...
  export default {
    ...
    methods: {
      clickOneCard (item, itemValue) {
        if ((itemValue === 'user_id' && (this.which === 'child' || this.which === 'parent' || this.which === 'orderGods')) ||
          (itemValue === 'class_id' && (this.which === 'class' || this.which === 'stuclass' || this.which === 'spaceClass')) ||
          itemValue === 'author' || itemValue === 'owner'
        ) {
