...
<script>
  ...
  export default {
    data () {
      return {
        allTitle: {userinfo: '用户信息', child: '孩子信息', class: '班级信息', parent: '家长信息', stuclass: '所在班级信息', onlyClass: '班级信息', orderGods: '订单信息'},
        ...
        allKey: {
          ...
          onlyClass: [
            ...
            [['class_mode', '班级性质:'], ['status', '状态:'], ['tag_open', '允许老师加入:'], ['tag_open', '允许学生加入:'], ['graduated', '是否毕业:'],
              ['school_id', '学校ID:'], ['seq_id', '班级号:'], ['last_upt_user', '最近更新人:'], ['in_time', '创建时间:'], ['last_time', '最近更改时间:']
            ]
          ],
          orderGods: [
            [['amount', '变更金额:'], ['amount_status', '收支情况:'], ['app_id', 'appID:'], ['before_amount', '变更前金额:'], ['currecy_id', '货币类型:'],
              ['current_amount', '余额:'], ['detail_id', 'detailID:']
            ],
            [['op_user_id', '操作者ID:'], ['sub_id', 'subID:'], ['user_id', '用户ID:'], ['in_time', '变更时间:'], ['task_time', '变更时间:'], ['remark', '备注:'], ['ip', 'IP:']]
          ]
        },
        formatGender,
        formatUserRole,
