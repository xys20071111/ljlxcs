<template>
  ...
  >
    <template slot="items" slot-scope="props">
      <tr @click.stop="which === 'classManage1' ? $emit('jumpToMan', props.item.user_id) : $emit('clickList', props.item, props.index)"
        :style="clickWhich && clickWhich[0] && clickWhich[1] === props.index && {'background':'#4FC3F7'}"
      >
