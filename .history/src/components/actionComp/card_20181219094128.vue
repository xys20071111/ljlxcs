    ...
    data () {
      return {
        ...
        allKey: {
          ...
          onlyClass: [
            [{eng: 'class_id', chn: '班级ID:'}, {eng: 'def_name', chn: '系统班级名称:'}, {eng: 'class_name', chn: '自定义班级名称:'}, {eng: 'cnt_teacher', chn: '教师人数:'}, {eng: 'cnt_stu', chn: '学生人数:'}, {eng: 'cnt_parent', chn: '家长人数:'}, {eng: 'born_year', chn: '届(年):'}, {eng: 'stage', chn: '学段:'}, {eng: 'grade', chn: '年级:'}, {eng: 'cert', chn: '认证状态:'}, {eng: 'last_upt_user', chn: '最近更新人:'}],
            [{eng: 'class_mode', chn: '班级性质:'}, {eng: 'tag_open', chn: '允许老师加入:'}, {eng: 'tag_open', chn: '允许学生加入:'}, {eng: 'graduated', chn: '是否毕业:'}, {eng: 'school_id', chn: '学校ID:'}, {eng: 'seq_id', chn: '班级ID:'}, {eng: 'in_time', chn: 'in_time:'}, {eng: 'last_time', chn: 'last_time:'}]
          ]
        },
        formatGender,
        formatUserRole,
