<template>
  ...
  >
    <template slot="items" slot-scope="props">
      ...
      :style="item.nowrap && {'white-space':'nowrap'}" style="word-break:break-all" @click.stop="clickListOne(props.item[item.value], item.value)">
