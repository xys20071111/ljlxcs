      ...
      return {
        ...
        allKey: {
          ...
          onlyClass: [
            ...
            [{eng: 'class_mode', chn: '班级性质:'}, {eng: 'tag_open', chn: '允许老师加入:'}, {eng: 'tag_open', chn: '允许学生加入:'}, {eng: 'in_time', chn: 'in_time:'}, {eng: 'last_time', chn: 'last_time:'}, {eng: 'graduated', chn: '是否毕业:'}, {eng: 'school_id', chn: '学校ID:'}, {eng: 'seq_id', chn: '班级ID:'}]
          ]
        },
        formatGender,
        formatUserRole,
