    ...
    <template slot="items" slot-scope="props">
      ...
      >
        ...
        >
          ...
          <span v-else-if="item.value === 'last_time'" style="min-width:160px;display:inline-block">
          ...
          <span v-else-if="item.value === 'country'" style="min-width:80px;display:inline-block">
          ...
          <span v-else-if="item.value === 'title'" style="min-width:80px;display:inline-block">{{ props.item.title }}</span>
          <span v-else-if="item.value === 'content'" style="max-width:300px;min-width:100px;display:inline-block">
            {{ props.item.content }}
  ...
  methods: {
    ...
    clickTdOne (e, item, itemValue) {
      if (item) {
        ...
        if (['owner', 'avatarjump'].includes(itemValue)) {
