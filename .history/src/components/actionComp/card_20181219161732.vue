  ...
  export default {
    data () {
      return {
        ...
        allTitleErr: {userinfo: '尚无用户信息', child: '用户尚无孩子', class: '用户尚未加入班级', parent: '用户尚没有家长', stuclass: '用户尚未存在班级内'},
        allKey: {
          userinfo: [
          ...
          child: [
            ...
            [{eng: 'p_id', chn: '推广员ID:'}, {eng: 'gender', chn: '性别:'}, {eng: 'country', chn: '地区:'}, {eng: 'intro', chn: '个人签名:'}, {eng: 'last_time', chn: '最近更改时间:'}]
          ],
          class: [
          ...
          onlyClass: [
            ...
            [{eng: 'class_mode', chn: '班级性质:'}, {eng: 'status', chn: '状态:'}, {eng: 'tag_open', chn: '允许老师加入:'}, {eng: 'tag_open', chn: '允许学生加入:'}, {eng: 'graduated', chn: '是否毕业:'}, {eng: 'school_id', chn: '学校ID:'}, {eng: 'seq_id', chn: '班级号:'}, {eng: 'last_upt_user', chn: '最近更新人:'}, {eng: 'in_time', chn: '创建时间:'}, {eng: 'last_time', chn: '最近更改时间:'}]
          ]
        },
        formatGender,
        formatUserRole,
