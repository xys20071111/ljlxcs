<template>
  ...
  >
    <template slot="items" slot-scope="props">
      ...
      :style="item.nowrap && {'white-space':'nowrap'}" @click="['allIntegral1', 'reconIntergral2'].indexOf(which) !== -1 ? clickDetail(props.item):''">
  ...
  data () {
    return {
      headersBox: {
        ...
        allIntegral1: [['atom', '订单号', 'left', false], ['user_id', '用户ID', 'left', false, true], ['before_amount', '变更前余额', 'center', false],
        ...
        reconIntergral2: [['atom', '订单号', 'left', true], ['user_id', '用户ID', 'left', true, true], ['before_amount', '变更前余额', 'center', true],
          ['current_amount', '余额', 'center', true], ['currecy_id', '货币类型', 'center', true], ['in_time', '变更时间', 'center', true],
