<template>
  ...
  >
    <template slot="items" slot-scope="props">
      <tr @click.stop="clickList(props.item)" >
...
<script>
import { getCountry, getStrTime, getStrFixed, getStrClass, formatStageGrade, formatClsStatus, formatAvatar } from '../../api/dist.js'
export default {
  components: {},
  ...
  methods: {
    getPageItems (news) {
      ...
      this.totalDesserts < 100 && pageBox.push({'text': '$vuetify.dataIterator.rowsPerPageAll', 'value': -1})
      return pageBox
    }
  }
}
