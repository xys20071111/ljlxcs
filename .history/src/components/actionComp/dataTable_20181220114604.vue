  ...
  data () {
    return {
      headersBox: {
        ...
        spaceStat: [['class_id', '班级ID', 'left', true, true], ['class_name', '班级名称', 'center', false], ['amount', '发布数量', 'center', true], ['city', '发布位置', 'right', true]],
        ...
        allIntegral1: [['user_id', '用户ID', 'left', true, true], ['amount', '变更金额', 'center', true], ['amount_status', '收入/支出', 'center', true],
        ...
        reconIntergral2: [['user_id', '用户ID', 'left', true, true], ['amount', '变更金额', 'center', true], ['amount_status', '收入/支出', 'center', true], ['app_id', 'appID', 'center', true], ['atom', '订单号', 'center', true],
