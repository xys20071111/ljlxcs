  ...
  data () {
    return {
      headersBox: {
        ...
        classSpace0: [['author', '发布者ID', 'left', true, true], ['class_id', '班级ID', 'left', true], ['cs_id', '分享ID', 'left', true],
          ['obj_id', 'objID', 'left', true], ['school_id', '学校ID', 'left', true], ['cnt_comment', '评论数', 'left', true], ['cnt_good', '点赞数', 'left', true],
