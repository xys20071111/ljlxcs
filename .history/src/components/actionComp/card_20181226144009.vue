    ...
    data () {
      return {
        ...
        allKey: {
          ...
          spaceClass: [
            [['obj_id', 'obj_id:'], ['author', '发布者ID:'], ['class_id', '班级ID:'], ['cs_id', '分享ID:'], ['cnt_comment', '评论数:'], ['cnt_good', '点赞数:'], ['cont', '文字内容:']
            ],
            [['uriImage', '图片个数:'], ['uriVideo', '视频个数:'], ['uriRecord', '录音个数:'], ['faved', '是否收藏:'], ['thumbed', '是否点赞:'], ['in_time', '发布时间:'], ['ip', 'ip:'], ['school_id', '学校ID:']
            ]
