    ...
    data () {
      return {
        ...
        allKey: {
          ...
          onlyClass: [
            [{eng: 'class_id', chn: '班级ID:'}, {eng: 'cnt_teacher', chn: '教师人数:'}, {eng: 'cnt_stu', chn: '学生人数:'}, {eng: 'cnt_parent', chn: '家长人数:'}, {eng: 'born_year', chn: '届(年):'}, {eng: 'stage', chn: '学段:'}, {eng: 'grade', chn: '年级:'}, {eng: 'cert', chn: '认证状态:'}, {eng: 'last_upt_user', chn: '最近更新人:'}, {eng: 'class_mode', chn: '班级性质:'}],
