<template>
  ...
  >
    <template slot="items" slot-scope="props">
      <tr @click="['allIntegral1', 'reconIntergral2', 'classSpace0'].indexOf(which) !== -1 ? clickDetail(props.item):''">
    ...
    return {
      headersBox: {
        ...
        classSpace0: [['author', '发布者ID', 'left', true, true], ['class_id', '班级ID', 'left', true, true], ['cs_id', '分享ID', 'left', true, true],
          ['obj_id', '动态ID', 'left', true, true], ['school_id', '学校ID', 'left', true, true], ['cnt_comment', '评论数', 'left', true], ['cnt_good', '点赞数', 'left', true],
