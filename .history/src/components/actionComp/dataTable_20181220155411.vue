  ...
  data () {
    return {
      headersBox: {
        ...
        allIntegral1: [['in_time', '变更时间', 'center', true], ['user_id', '用户ID', 'left', true, true], ['amount', '变更金额', 'center', true], ['amount_status', '收入/支出', 'center', false],
          ['app_id', 'appID', 'center', true], ['atom', '订单号', 'center', true], ['before_amount', '变更前余额', 'center', true], ['current_amount', '余额', 'center', true],
          ['currecy_id', '货币类型', 'center', true], ['detail_id', 'detailId', 'center', true], ['op_user_id', 'opUserId', 'center', true], ['sub_id', 'subId', 'center', true],
