<template>
  <v-data-table
    ...
    :loading="loading"
    :hide-actions="which === 'classManage1' || which === 'classSpace0'"
...
export default {
  ...
  watch: {
    desserts () {
      if (this.news === 'news' || this.which === 'classSpace0') {
  ...
  methods: {
    getPageItems (news) {
      ...
      this.which === 'classSpace0' && (pageBox = [{'text': '$vuetify.dataIterator.rowsPerPageAll', 'value': -1}])
      return pageBox
    }
  }
}
