          ...
          <v-list dense>
            <v-layout row wrap mb-2>
              <v-flex v-for="(item, index) in allKey[which]" :key="index">
                <v-list-tile v-for="(value, key) in item" :key="key" class="setHeight">
                  ...
                  <v-list-tile-content class="align-end" v-else style="word-break:break-all">{{ props.item[value[0]] }}</v-list-tile-content>
                </v-list-tile>
              </v-flex>
