          ...
          <v-list dense>
            <v-layout row wrap mb-2>
              <v-flex v-for="(item, index) in allKey[which]" :key="index">
                <v-list-tile v-for="(value, key) in item" :key="key" style="min-height:40px;height:auto">
                  ...
                  <v-list-tile-content class="align-end" v-else  style="overflow:visible;height:auto;min-height:40px">{{ props.item[value[0]] }}</v-list-tile-content>
                </v-list-tile>
              </v-flex>
