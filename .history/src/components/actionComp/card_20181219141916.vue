      ...
      return {
        ...
        allKey: {
          userinfo: [
            ...
            [{eng: 'country', chn: '地区:'}, {eng: 'in_time', chn: 'in_time:'}, {eng: 'last_time', chn: 'last_time:'}, {eng: 'intro', chn: '个人签名:'}]
          ],
          child: [
            [{eng: 'avatar', chn: '头像:'}, {eng: 'user_id', chn: 'ID:'}, {eng: 'uname', chn: '昵称:'}, {eng: 'realname', chn: '真实姓名:'}],
            [{eng: 'gender', chn: '性别:'}, {eng: 'country', chn: '地区:'}, {eng: 'last_time', chn: 'last_time:'}, {eng: 'intro', chn: '个人签名:'}]
          ],
          class: [
