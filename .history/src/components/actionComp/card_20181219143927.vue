            ...
            <v-layout row wrap mb-2>
              <v-flex v-for="(item, index) in allKey[which]" :key="index">
                <v-list-tile v-for="(value, key) in item" :key="key">
                  ...
                  <v-list-tile-content class="align-end" v-else-if="value.eng === 'status'">{{ formatStatus(props.item.status) }}</v-list-tile-content>
...
<script>
  import { formatGender, formatUserRole, formatAvatar, formatClassMode, getCountry, formatStageGrade, formatStatus } from '@/api/dist.js'
  export default {
    data () {
      return {
        ...
        allKey: {
          userinfo: [
            [{eng: 'user_id', chn: '用户ID:'}, {eng: 'uname', chn: '昵称:'}, {eng: 'realname', chn: '真实姓名:'}, {eng: 'mobile', chn: '手机号:'}, {eng: 'status', chn: '状态:'}],
            [{eng: 'gender', chn: '性别:'}, {eng: 'user_role', chn: '身份:'}, {eng: 'p_id', chn: '推广员ID:'}, {eng: 'origin', chn: '来源ID:'}, {eng: 'country', chn: '地区:'}],
            [{eng: 'in_time', chn: '创建时间:'}, {eng: 'last_time', chn: '最近更改时间:'}, {eng: 'intro', chn: '个人签名:'}]
          ],
          child: [
            [{eng: 'avatar', chn: '头像:'}, {eng: 'user_id', chn: 'ID:'}, {eng: 'uname', chn: '昵称:'}, {eng: 'realname', chn: '真实姓名:'}, {eng: 'mobile', chn: '手机号:'}, {eng: 'status', chn: '状态:'}],
            [{eng: 'p_id', chn: '推广员ID:'}, {eng: 'gender', chn: '性别:'}, {eng: 'country', chn: '地区:'}, {eng: 'last_time', chn: '最近更改时间:'}, {eng: 'intro', chn: '个人签名:'}]
          ],
          class: [
            [{eng: 'logo_url', chn: '班级头像:'}, {eng: 'class_id', chn: '班级ID:'}, {eng: 'def_name', chn: '系统班级名称:'}, {eng: 'class_name', chn: '自定义班级名称:'}, {eng: 'stage', chn: '学段:'}, {eng: 'grade', chn: '年级:'}],
            [{eng: 'class_mode', chn: '班级性质:'}, {eng: 'cnt_teacher', chn: '教师人数:'}, {eng: 'cnt_stu', chn: '学生人数:'}, {eng: 'cnt_parent', chn: '家长人数:'}, {eng: 'born_year', chn: '届(年):'}, {eng: 'last_time', chn: '最近更改时间:'}]
          ],
          parent: [
            [{eng: 'avatar', chn: '头像:'}, {eng: 'user_id', chn: '用户ID:'}, {eng: 'uname', chn: '昵称:'}, {eng: 'realname', chn: '真实姓名:'}, {eng: 'gender', chn: '性别:'}],
            [{eng: 'mobile', chn: '手机号:'}, {eng: 'country', chn: '地区:'}, {eng: 'p_id', chn: '推广员ID:'}, {eng: 'in_time', chn: '创建时间:'}, {eng: 'last_time', chn: '最近更改时间:'}]
          ],
          stuclass: [
            [{eng: 'logo_url', chn: '班级头像:'}, {eng: 'class_id', chn: '班级ID:'}, {eng: 'def_name', chn: '系统班级名称:'}, {eng: 'class_name', chn: '自定义班级名称:'}, {eng: 'class_mode', chn: '班级性质:'}],
            [{eng: 'cnt_teacher', chn: '教师人数:'}, {eng: 'cnt_stu', chn: '学生人数:'}, {eng: 'cnt_parent', chn: '家长人数:'}, {eng: 'born_year', chn: '届(年):'}, {eng: 'stage', chn: '学制:'}, {eng: 'grade', chn: '年级:'}]
          ],
          onlyClass: [
            [{eng: 'class_id', chn: '班级ID:'}, {eng: 'def_name', chn: '系统班级名称:'}, {eng: 'class_name', chn: '自定义班级名称:'}, {eng: 'cnt_teacher', chn: '教师人数:'}, {eng: 'cnt_stu', chn: '学生人数:'}, {eng: 'cnt_parent', chn: '家长人数:'}, {eng: 'born_year', chn: '届(年):'}, {eng: 'stage', chn: '学段:'}, {eng: 'grade', chn: '年级:'}, {eng: 'cert', chn: '认证状态:'}],
            [{eng: 'class_mode', chn: '班级性质:'}, {eng: 'tag_open', chn: '允许老师加入:'}, {eng: 'tag_open', chn: '允许学生加入:'}, {eng: 'graduated', chn: '是否毕业:'}, {eng: 'school_id', chn: '学校ID:'}, {eng: 'seq_id', chn: '班级号:'}, {eng: 'last_upt_user', chn: '最近更新人:'}, {eng: 'in_time', chn: 'in_time:'}, {eng: 'last_time', chn: 'last_time:'}]
          ]
        },
        formatGender,
        formatUserRole,
