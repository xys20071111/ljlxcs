<template>
  ...
  >
    <template slot="items" slot-scope="props">
      ...
      :style="item.nowrap && {'white-space':'nowrap'}" @click="which === 'allIntegral1'?clickDetail(123):''">
  ...
  data () {
    return {
      headersBox: {
        ...
        allIntegral1: [['atom', '订单号', 'center', true], ['user_id', '用户ID', 'left', true, true], ['amount', '变更金额', 'center', true], ['amount_status', '收入/支出', 'center', false],
          ['app_id', 'appID', 'center', true], ['before_amount', '变更前余额', 'center', true], ['current_amount', '余额', 'center', true],
