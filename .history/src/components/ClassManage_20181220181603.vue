...
<div>
  <v-layout column wrap>
    ...
    <v-flex>
      <dataTable1 :desserts="desserts" :totalDesserts="totalDesserts" which="classManage0" :loading="loading" @getclasslist="getclasslist" @clickList="clickListTableItem"></dataTable1>
      <!-- <v-data-table
