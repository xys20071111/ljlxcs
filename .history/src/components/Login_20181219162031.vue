  ...
  <div class="wrap" id="loginroom">
      <v-content>
          <v-container fluid fill-height justify-center>
            <v-layout align-center justify-center column reverse style="just-content:center;padding:20px;flex:0 0 auto;background:#fff">
                <div v-if="!scCode" style="margin-top:10px;font-size:14px">请用微信小程序扫描以上二维码</div>
                <div id="qrcode"></div>
