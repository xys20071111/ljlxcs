          ...
          <v-layout row wrap>
            ...
            <v-flex xl12 lg12 xs12 sm12 md12 d-flex >
              ...
              <v-toolbar flat color="white">
                ...
                <v-spacer></v-spacer>
                <Dialog color="info" butCont="移除" alert="true"  which="quitclass" @quitclass="setclass"></Dialog>
                  <Dialog color="green darken-1" butCont="+ 添加成员" alert="true" :unbindWho="items" which="addMember" @addMember="setclass"></Dialog>
                <v-btn
