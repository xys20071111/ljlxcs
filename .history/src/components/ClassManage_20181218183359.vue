    ...
    <v-flex>
      ...
      >
        <template slot="items" slot-scope="props">
          ...
          <td class="text-xs-right">{{ ['','幼儿园','小学','初中','高中','职高','大专','硕士','博士','博士后'][props.item.stage] || '未知' }}</td>
...
import { formatGender, formatUserRole, formatStatus, formatClsStatus, formatAvatar, formatEduRole, formatClassMode } from '../api/dist.js'
const api = new API()
  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: '学段', value: 'stage', align: 'right', sortable: false },
