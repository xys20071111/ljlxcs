                        ...
                        <v-layout row wrap>
                          ...
                          >
                            <v-card flat tile class="d-flex">
                              <Dialog which="imageLook" media="media" v-if="item[0] === 1" :imageArr="['', 360, 360, item[1][1], noImage]"></Dialog>
                              <Dialog which="videoLook" media="media" v-if="item[0] === 2" :imageArr="['视频', 360, 360, item[1][1], noVideo, item[1][0]]"></Dialog>
