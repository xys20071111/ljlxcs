  ...
  <v-layout column wrap>
    ...
    <v-flex>
      ...
      <v-layout row wrap>
        ...
        <v-btn :color="role === 1 ? 'success' : 'primary'" depressed @click="clickUserListRole(3)">老师</v-btn>
        <v-btn :color="role === 2 ? 'success' : 'primary'" depressed @click="clickUserListRole(2)">家长</v-btn>
        <v-btn :color="role === 3 ? 'success' : 'primary'" depressed @click="clickUserListRole(1)">学生</v-btn>
        <v-divider
          class="mx-3"
          inset
          vertical
