<template>
   <div>
    ...
    <dataTable :which="'reconIntergral' + buttonIndex" :desserts="desserts" :loading="loading" :news="news"
      :setNew.sync="news" @getNew="getNew" :setDrawer.sync="drawer" :setItem.sync="items" v-show="buttonIndex === 2">
    </dataTable>
    ...
    <v-layout>
      ...
      <v-list class="pt-0" dense>
          ...
          <v-container fluid grid-list-md>
            <v-layout row wrap>
              <Card  xl12 lg12 xs12 sm12 md12 d-flex  which="orderGods" :data="[items]" v-if="items" @jumpToChildClass="jumpToMan">
              </Card>
            </v-layout>
          </v-container>
      </v-list>
