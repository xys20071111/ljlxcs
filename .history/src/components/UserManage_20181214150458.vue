          ...
          if (msg.code === 0) {
            ...
            if (whichEle === 'setMan') {
              ...
              this.desserts.forEach(element => {
                element.user_id === this.items.user_id && (element.uname = props[0])
                element.user_id === this.items.user_id && (element.gender = props[1])
                element.user_id === this.items.user_id && (element.user_role = props[2])
              })
