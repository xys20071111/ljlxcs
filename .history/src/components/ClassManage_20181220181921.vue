...
<div>
  <v-layout column wrap>
    ...
    <v-flex>
      <dataTable1 :desserts="desserts" :pagination.sync="pagination" :totalDesserts="totalDesserts" which="classManage0" :loading="loading" @getclasslist="getclasslist" @clickList="clickListTableItem"></dataTable1>
      <!-- <v-data-table
...
import { formatGender, formatUserRole, formatStatus, formatClsStatus, formatAvatar, formatEduRole, formatClassMode, formatStageGrade, getStrClass } from '../api/dist.js'
export default {
  name: 'UserManage',
