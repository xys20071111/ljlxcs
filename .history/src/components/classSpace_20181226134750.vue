                        ...
                        <v-layout row wrap>
                          ...
                          >
                            <v-card flat tile class="d-flex">
                              <Dialog which="imageLook" media="media" v-if="item[0] === 1" :imageArr="['', 500, 500, item[1][1], noImage]"></Dialog>
                              <Dialog which="videoLook" media="media" v-if="item[0] === 2" :imageArr="['视频', 300, 300, item[1][1], noVideo, item[1][0]]"></Dialog>
                              <Dialog which="recordLook" media="media" v-if="item[0] === 3" :imageArr="['录音', 260, 300, noRecord, noRecord, item[1][0]]"></Dialog>
                            </v-card>
                          </v-flex>
                        </v-layout>
                      </v-container>
